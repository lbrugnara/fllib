...
cl.exe  /I.\include  /W1 /Od /Z7 /DEBUG:FULL /c .\tests\containers\binary-heap.unit.c /Fo.\obj\win\x86_64\msvc\msvc-debug\tests\containers\binary-heap.unit.o 
