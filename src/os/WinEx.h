...
typedef BOOL (*FlWinCmdControlHandler)( DWORD ctrlType );
  ...
  *
  * DWORD exceptionCode - Exception type
  * FlWinExceptionHandler handler - Handler function
  *
 ...
 * of type {ctrl} occurs
 *
 * DWORD ctrl - Specific control handler (CTRL_C_EVENT, CTRL_CLOSE_EVENT, CTRL_BREAK_EVENT, CTRL_LOGOFF_EVENT or CTRL_SHUTDOWN_EVENT)
 * FlWinCmdControlHandler handler - Handler function
 *
 * {return: void}
 *
 */
