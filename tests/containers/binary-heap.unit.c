...
flut_define_suite(
    ...
    // TEST CASE
    flut_test(new, "fl_binheap_new and fl_binheap_new_args function", {

        flut_describe("Calling fl_binheap_new(_args) function with valid parameters should return valid binary heaps") {
        ...
        flut_describe("Calling fl_binheap_new(_args) function with invalid configuration must return NULL") {
    ...
    // TEST CASE
    flut_test(insert, "fl_binheap_insert function", {
        srand(time(NULL));
