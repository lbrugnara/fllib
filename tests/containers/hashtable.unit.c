...
static unsigned long hash_func(const FlByte *key);
static unsigned long hash_func2(const FlByte *key);
static bool key_comparer2(const FlByte *key1, const FlByte *key2);
static void size_t_writer(FlByte **dest, const FlByte *src);
static void allocate_struct(FlByte **dest, const FlByte *src);
...
flut_define_suite(
    ...
    // TEST CASE
    flut_test(add, "fl_hashtable_add function", {
        // Common use cases
        {
    ...
    // TEST CASE
    flut_test(add_with_hash, "fl_hashtable_add with a hash", {
    ...
    // TEST CASE
    flut_test(get, "fl_hashtable_get function", {
        // Normal usage
        {
            FlHashtable *ht = fl_hashtable_new_args((struct FlHashtableArgs) {
                .hash_function = fl_hashtable_hash_char,
    ...
    flut_test(set, "fl_hashtable_set function", {
        FlHashtable *ht = fl_hashtable_new_args((struct FlHashtableArgs) {
            .hash_function = fl_hashtable_hash_char,
            .key_comparer = fl_container_equals_char,
            .key_cleaner = fl_container_cleaner_pointer,
    ...
    flut_test(clear, "fl_hashtable_clear function", {
        FlHashtable *ht = fl_hashtable_new_args((struct FlHashtableArgs) {
                .hash_function = fl_hashtable_hash_char,
                .key_comparer = fl_container_equals_char,
                .key_cleaner = fl_container_cleaner_pointer,
    ...
    flut_test(keys_and_values, "fl_hashtable_keys and fl_hashtable_values functions", {
        FlHashtable *ht = fl_hashtable_new_args((struct FlHashtableArgs) {
            .hash_function = fl_hashtable_hash_char,
            .key_comparer = fl_container_equals_char,
            .key_cleaner = fl_container_cleaner_pointer,
    ...
    flut_test(remove, "fl_hashtable_remove function", {
        FlHashtable *ht = fl_hashtable_new_args((struct FlHashtableArgs) {
            .hash_function = fl_hashtable_hash_char,
            .key_comparer = fl_container_equals_char,
            .key_cleaner = fl_container_cleaner_pointer,
    ...
    flut_test(resize, "fl_hashtable_resize function", {
        FlHashtable *ht = fl_hashtable_new_args((struct FlHashtableArgs){
    ...
    flut_test(values, "fl_hashtable_values function", {
