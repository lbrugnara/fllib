...
flut_define_suite(
    ...
    // TEST CASE
    flut_test(replace_char, "Cstring replace char", {
        char *world = "World";
    ...
    // TEST CASE
    flut_test(replace, "Cstring replace", {
    ...
    // TEST CASE
    flut_test(append, "Cstring append", {
